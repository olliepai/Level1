public class Backpack {
	...
	public static void main (String[] args){
		...
		Backpack object = new Backpack();
		Pencil pencil = new Pencil();
		Ruler ruler = new Ruler();
		Textbook textbook = new Textbook();
		object.putInBackpack(pencil);
		object.putInBackpack(ruler);
		object.putInBackpack(textbook);
		object.goToSchool();
	...
	public void goToSchool(){
		if(pencil == null || ruler == null || textbook == null){
			...
			System.out.println("Congratulations! You are not very ready for school. You are ugly!");
		}
	}
}
